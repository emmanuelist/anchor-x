...
const BASE_TITLE = 'AnchorX';
const BASE_URL = 'https://anchorx.io';
...
export function usePageMeta({ title, description, canonicalPath }: PageMeta) {
  useEffect(() => {
    ...
    ogTitle.setAttribute('content', `${title} | ${BASE_TITLE}`);
    ...
    twitterTitle.setAttribute('content', `${title} | ${BASE_TITLE}`);
